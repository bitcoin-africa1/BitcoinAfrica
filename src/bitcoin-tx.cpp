...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoinafrica-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoinafrica-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoinafrica transaction\n" +
            "or:     bitcoinafrica-tx [options] -create [commands]   Create hex-encoded bitcoinafrica transaction\n" +
            "\n";
