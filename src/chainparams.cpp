...
{
    const char* pszTimestamp = "Joe Biden Signs 1.9T stimulus bill - 10th march 2021 CNBC";
    const CScript genesisOutputScript = CScript() << ParseHex("043fd1b01692bfa153f0c0b03672d38c09f42d46edba4ff5659818537f330cace08f8ec63231bdbed7a9674868ec3c800cd10d67465df1d9d0ad241116740aa34a") << OP_CHECKSIG;
...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("209.145.63.101");
        vSeeds.emplace_back("209.145.63.100");
...
public:
    CTestNetParams() {
        ...
        consensus.BIP34Hash = uint256S("0x50cf739b3abac9abc5a8b8202b277a5c6b073bc1302e399d58ccb122182861de");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        base58Prefixes[SECRET_KEY] =     std::vector<unsigned char>(1,239);
        base58Prefixes[EXT_PUBLIC_KEY] = {0x09, 0x45, 0x87, 0xCF};
        base58Prefixes[EXT_SECRET_KEY] = {0x09, 0x45, 0x83, 0x94};
