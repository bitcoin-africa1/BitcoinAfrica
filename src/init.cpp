 ...
 */
static const char* BITCOIN_PID_FILENAME = "bitcoinafricad.pid";
...
void Shutdown(InitInterfaces& interfaces)
{
    ...
    RenameThread("bitcoinafrica-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/bitcoin-africa/Bitcoin-Africa>";
    const std::string URL_WEBSITE = "<https://bitcoinafrica.org>";
...
static void ThreadImport(std::vector<fs::path> vImportFiles)
{
    ...
    RenameThread("bitcoinafrica-loadblk");
...
bool AppInitMain(InitInterfaces& interfaces)
{
    ...
    if (gArgs.IsArgSet("-datadir") && !fs::path(gArgs.GetArg("-datadir", "")).is_absolute()) {
        LogPrintf("Warning: relative datadir option '%s' specified, which will be interpreted relative to the " /* Continued */
                  "current working directory '%s'. This is fragile, because if bitcoinafrica is started in the future "
                  "from a different location, it will be unable to locate the current data files. There could "
                  "also be data loss if bitcoinafrica is started while in a temporary directory.\n",
