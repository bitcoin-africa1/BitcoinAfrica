...
bech32_templates = [
  ...
  ('btca',   0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('btca',   0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('btca',   1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tbtca',  0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tbtca',  0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tbtca',  2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('rbtca',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('rbtca',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('rbtca', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
# templates for invalid bech32 sequences
bech32_ng_templates = [
  # hrp, version, witprog_size, invalid_bech32, invalid_checksum, invalid_char
  ('tc',    0, 20, False, False, False),
  ('tbtca',  17, 32, False, False, False),
  ('rbtca',  3,  1, False, False, False),
  ('btca',   15, 41, False, False, False),
  ('tbtca',  0, 16, False, False, False),
  ('rbtca',  0, 32, True,  False, False),
  ('btca',   0, 16, True,  False, False),
  ('tbtca',  0, 32, False, True,  False),
  ('rbtca',  0, 20, False, False, True)
]
