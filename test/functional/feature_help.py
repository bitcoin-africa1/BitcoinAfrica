...
"""Verify that starting bitcoinafrica with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoinafrica with -h for help text")
        ...
        self.log.info("Start bitcoinafrica with -version for version information")
        ...
        self.log.info("Start bitcoinafricad with -fakearg to make sure it does not start")
